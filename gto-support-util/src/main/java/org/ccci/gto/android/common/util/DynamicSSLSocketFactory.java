...
public class DynamicSSLSocketFactory extends SSLSocketFactory {
    ...
    public Socket createSocket(final Socket s, final String host, final int port, final boolean autoClose)
            throws IOException {
        return adjustSocket(delegate.createSocket(s, host, port, autoClose));
    }

    @Override
    public Socket createSocket(final String host, final int port) throws IOException {
        return adjustSocket(delegate.createSocket(host, port));
    }

    @Override
    public Socket createSocket(final String host, final int port, final InetAddress localHost, final int localPort)
            throws IOException {
        return adjustSocket(delegate.createSocket(host, port, localHost, localPort));
    }
    ...
    public Socket createSocket(final InetAddress address, final int port, final InetAddress localAddress,
        ...
        return adjustSocket(delegate.createSocket(address, port, localAddress, localPort));
    }
