...
public class AccountManagerCompatTest {
    ...
    public void verifyRemoveAccountExplicitly() throws Exception {
        ...
        assertThat(AccountManagerCompat.removeAccountExplicitly(accountManager, ACCOUNT_1).getResult(), is(true));
        ...
        assertThat(AccountManagerCompat.removeAccountExplicitly(accountManager, ACCOUNT_2).getResult(), is(true));
        assertThat(Arrays.asList(accountManager.getAccountsByType(ACCOUNT_TYPE)), is(empty()));
    }
}
